...
**Write one line per angle into `PLAN.md`'s `## Self-review` section, naming the answer.** The handoff may report clean only when those four lines are in the file — a verdict asserted in the message and nowhere else is a self-review that did not happen.
